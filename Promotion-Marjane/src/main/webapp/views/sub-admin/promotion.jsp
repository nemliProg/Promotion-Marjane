            ...
            <div class="py-6">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div class="py-4">
                        ...
                        <div class="p-4">
                            <form action="/sub-admin/promotions" method="POST">
                                <div class="shadow sm:rounded-md sm:overflow-hidden">
                                    <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                                        <div>
                                            <h3 class="text-lg leading-6 font-medium text-gray-900">Add Admin To A Center</h3>
                                            <p class="mt-1 text-sm text-gray-500">Use a permanent address where Sub Admin can recieve mail.</p>
                                        </div>

                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="percentage" class="block text-sm font-medium text-gray-700">percentage</label>
                                                <input required type="number" name="percentage" id="percentage" autocomplete="given-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="categorie" class="block text-sm font-medium text-gray-700">Select Categorie</label>
                                                <select required id="categorie" name="categorie" autocomplete="country-name" class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="date" name="start-date" id="start-date" autocomplete="family-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="end-date" class="block text-sm font-medium text-gray-700">End Date</label>
                                                <input type="date" name="end-date" id="end-date" autocomplete="given-name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            </div>
