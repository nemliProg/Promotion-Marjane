    ...
    <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
      ...
      <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
        ...
        <nav class="mt-5 px-2 space-y-1">
          ...
          <a href="/dashboard-admin" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
            <!--
          ...
          <a href="/admin/sub-admins" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
      ...
      <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div class="py-4">
                            ...
                            <c:choose>
                              <c:when test="${i.count % 2 == 0 }">
                                <tr class="bg-white">
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><c:out value="${subAdmin.centreById.nom}" /></td>
            ...
            <div class="p-4">
              <form action="/admin/sub-admins" method="POST">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                  <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                      ...
                      <div class="col-span-6 sm:col-span-3">
                        <label for="center" class="block text-sm font-medium text-gray-700">Select Center</label>
                        <select id="center" name="center" autocomplete="country-name" class="mt-1 block w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                          <option>Select a Center</option>
                            <c:forEach items="${centersSelect}" var="center">
                                <option value="<c:out value="${center.id}" />"><c:out value="${center.nom}" /> - <c:out value="${center.ville}" /></option>
                            </c:forEach>
                        </select>
                      </div>
